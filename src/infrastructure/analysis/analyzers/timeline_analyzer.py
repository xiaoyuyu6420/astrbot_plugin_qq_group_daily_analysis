...
- 重复刷屏、表情包接龙
- 广告/推广/抽奖/集赞/砍价：「新店开业全场 5 折」「帮我砍一刀」「抽奖送手机」
- 纯晒图/晒战绩/晒日常，无讨论无信息：「刚打完的局」（配图）、「今天天气真好」
- 打卡签到：「第 30 天打卡」「签到成功」
- 无上下文转发（链接/视频不带任何说明和讨论，甩个链接就走）
- 求互关互赞、拉群邀请
判断标准：如果抽离出来单独看，读者会觉得「这有啥」，就不要。硬门槛：把这条消息抽掉，读者会不会觉得「今天缺了点啥」？不会 → 不收。宁可漏收，也不要让日报被垃圾稀释。
